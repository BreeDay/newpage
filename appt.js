...
let superbScene = new ScrollMagic.Scene({
    triggerElement: about3,
    duration: 3500,
    triggerHook: 0
})
...
let cloud1Scene = new ScrollMagic.Scene({
    triggerElement: about3,
    duration: 3500,
    triggerHook: 0
})
...
let tcloud2 = new TimelineLite();

tcloud2.add(
    TweenLite.to(".cloud2", 1, {
        bezier: cloud2Path,
        ease: Power1.easeInOut
    })
);
...
let cloud2Scene = new ScrollMagic.Scene({
    triggerElement: about3,
    duration: 3500,
    triggerHook: 0
})
...
let tcloud3 = new TimelineLite();

tcloud3.add(
    TweenLite.to(".cloud3", 1, {
        bezier: cloud3Path,
        ease: Power1.easeInOut
    })
);
...
let cloud3Scene = new ScrollMagic.Scene({
    triggerElement: about3,
    duration: 3500,
    triggerHook: 0
})
...
let tamb = new TimelineLite();

tamb.add(
    TweenLite.to(".ambulance", 1, {
        bezier: ambPath,
        ease: Power1.easeInOut
    })
);
...
let ambScene = new ScrollMagic.Scene({
    triggerElement: about5,
    duration: 2000,
    triggerHook: 0
})
...
let tgear1 = new TimelineLite();

tgear1.add(
    TweenLite.to(".gear1", 1, {
        bezier: gear1Path,
        ease: Power1.easeInOut
    })
);
...
let gear1Scene = new ScrollMagic.Scene({
    triggerElement: about8,
    duration: 2000,
    triggerHook: 0
})
...
let tgear2 = new TimelineLite();

tgear2.add(
    TweenLite.to(".gear2", 1, {
        bezier: gear2Path,
        ease: Power1.easeInOut
    })
);
...
let gear2Scene = new ScrollMagic.Scene({
    triggerElement: about8,
    duration: 2000,
    triggerHook: 0
})
